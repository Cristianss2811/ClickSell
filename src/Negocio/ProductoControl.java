...
public class ProductoControl {
    ...
    public DefaultTableModel listar(String texto){
        ...
        String titulos[]={"Nombre Producto",  "Descripcion", "ImagenProducto","Precio de venta", "Existencia", "Precio de compra", 
        "Ganancia", "Estado" };
        ...
        for(Producto item: lista){
            ...
            registro[2] = ""+item.getImgProducto();
            registro[3] = ""+item.getPrecioVenta();
            registro[4] = ""+item.getExistencia();
            registro[5] = ""+item.getPrecioCompra();
            registro[6] = ""+item.getGanancia();
